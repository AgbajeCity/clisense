"""Export the Osun River corridor dataset to CSV (real rainfall from NASA
POWER, with derived discharge/soil-moisture/vegetation-index - see
app/model_core.py for the full provenance disclosure).
